...
class ReportViewSet(viewsets.ModelViewSet):
    """
    CRUD for reports, including nested expense management.
    Also includes:
      - /<id>/expenses/ to list a report's expenses
      - /<id>/print/ to download a themed PDF
    """
    ...
    # ✅ Allow PUT/PATCH with nested expenses
